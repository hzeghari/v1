...
(0, _apiRunnerBrowser.apiRunnerAsync)(`onClientEntry`).then(() => {
                  ...
                  (0, _extends2.default)(
                    {
                      path:
                        pageResources.page.path === `/404.html`
                          ? (0, _stripPrefix.default)(location.pathname, __BASE_PATH__)
                          : encodeURI(pageResources.page.matchPath || pageResources.page.path),
                    },
                    this.props,
                    {
                      location: location,
  ...
  if (
    ...
    !(
      loader.findMatchPath((0, _stripPrefix.default)(browserLoc.pathname, __BASE_PATH__)) ||
      pagePath === `/404.html` ||
      pagePath.match(/^\/404\/?$/) ||
