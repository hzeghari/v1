...
describe(`Dev loader`, () => {
  describe(`loadPageDataJson`, () => {
    ...
    it(`should load a 404 page when page-path file is not a gatsby json`, async () => {
      ...
      expect(await devLoader.loadPageDataJson(`/unknown-page/`)).toEqual(expectation);
    ...
    it(`should return an error when status is 500`, async () => {
      ...
      expect(await devLoader.loadPageDataJson(`/error-page/`)).toEqual(expectation);
    ...
    it(`should retry 3 times before returning an error`, async () => {
      ...
      expect(await devLoader.loadPageDataJson(`/blocked-page/`)).toEqual(expectation);
  ...
  describe(`prefetch`, () => {
    ...
    it(`should prefetch when not yet triggered`, async () => {
      ...
      expect(devLoader.apiRunner).toHaveBeenNthCalledWith(2, `onPostPrefetchPathname`, {
        pathname: `/mypath/`,
      });
    });
